...
export class BotWorker {
     ...
     */
    public constructor(controller: Hivekit, config) {
    ...
    /**
     * Get a reference to the main Hivekit controller.
     */
    public get controller(): Hivekit {
     ...
     */
    public async say(message: Partial<HivekitMessage> | string): Promise<any> {
    ...
    * @returns Return value will contain the results of the send action, typically `{id: <id of message>}`
    */
    public async reply(src: Partial<HivekitMessage>, resp: Partial<HivekitMessage> | string): Promise<any> {
    ...
    public async beginDialog(id: string, options?: any): Promise<void> {
        if (this._config.dialogContext) {
            await this._config.dialogContext.beginDialog(id + ':hivekit-wrapper', {
    ...
    public async replaceDialog(id: string, options?: any): Promise<void> {
        if (this._config.dialogContext) {
            await this._config.dialogContext.replaceDialog(id + ':hivekit-wrapper', {
                user: this.getConfig('context').activity.from.id,
                channel: this.getConfig('context').activity.conversation.id,
                ...options
            });
     ...
     */
    public ensureMessageFormat(message: Partial<HivekitMessage> | string): Partial<Activity> {
