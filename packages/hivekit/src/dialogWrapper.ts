...
import { HivekitConversationStep } from './conversation';
 ...
 */
export class HivekitDialogWrapper {
    private dc: DialogContext;
    private step: HivekitConversationStep;
    /**
    ...
    public constructor(dc: DialogContext, step: HivekitConversationStep) {
        this.dc = dc;
        this.step = step;
