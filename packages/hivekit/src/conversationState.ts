 ...
 * This allows Hivekit to automatically track conversation state in scenarios where multiple users are present in a single channel,
 ...
 * Note: This is used automatically inside Hivekit and developers should not need to directly interact with it.
 * @ignore
 */
export class HivekitConversationState extends ConversationState {
