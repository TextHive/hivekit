...
const USER_AGENT: string = `Microsoft-BotFramework/3.1 Hivekit/${ pjson.version } ` +
 ...
 */
export class HivekitBotFrameworkAdapter extends BotFrameworkAdapter {
    public hivekit_worker = TeamsBotWorker;

    /**
     * Allows for mocking of the connector client in unit tests.
     * Overridden by Hivekit in order to change userAgent.
     * @ignore
