...
const { HivekitConversationState } = require('../lib/conversationState');
const { MemoryStorage } = require('botbuilder');

const storage = new MemoryStorage();
const state = new HivekitConversationState(storage);

describe('HivekitConversationState', function() {
