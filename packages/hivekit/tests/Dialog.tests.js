...
const { Hivekit, HivekitTestClient, HivekitConversation } = require('../');

let bot;

describe('Hivekit dialog', function() {
    beforeEach(async () => {
        bot = new Hivekit({
    ...
    it('should follow a dialog', async function() {
        const introDialog = new HivekitConversation('introduction', bot);
        introDialog.ask({
            type: 'message',
            text: 'You can say Ok',
            quick_replies: [{
        ...
        const client = new HivekitTestClient('test', bot, 'introduction');
    ...
    it('should work with convo.repeat', async function() {
        const botConvo = new HivekitConversation('testConvo', bot);
        ...
        // set up a test client
        const client = new HivekitTestClient('test', bot, 'testConvo');
    ...
    it('should work with call to addchildDialog', async function() {
        ...
        const botConvo2 = new HivekitConversation('testConvo2', bot);
        ...
        // set up a test client
        const client = new HivekitTestClient('test', bot, ['testConvo', 'testConvo2']);
    ...
    it('should handle a series of child dialogs', async function() {
        ...
        const conversationChildDialogs = new HivekitConversation('child_dialogs', bot);
        const conversationA = new HivekitConversation('A', bot);
        const conversationB = new HivekitConversation('B', bot);
        const conversationC = new HivekitConversation('C', bot);
        const conversationD = new HivekitConversation('D', bot);
        ...
        const client = new HivekitTestClient('test', bot, ['child_dialogs', 'A', 'B', 'C', 'D']);
    ...
    it('should call handlers for addQuestion and ask with entire message payload', async () => {
        const conversation = new HivekitConversation('nameConvo', bot);
        ...
        // set up a test client
        const client = new HivekitTestClient('test', bot, ['nameConvo']);
