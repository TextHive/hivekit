...
import { Hivekit, HivekitMessage, BotWorker } from 'hivekit';
...
export class SlackBotWorker extends BotWorker {
     ...
     * ```
     *
     * @param hivekit The Hivekit controller object responsible for spawning this bot worker
     * @param config Normally, a DialogContext object.  Can also be the id of a team.
     */
    public constructor(hivekit: Hivekit, config: any) {
