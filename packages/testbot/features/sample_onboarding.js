...
module.exports = function(controller) {
    ...
    const confirmation = new HivekitConversation(CONFIRM_DIALOG, controller);
    ...
    const startover = new HivekitConversation(START_OVER, controller);
    ...
    /**
     * Now, define a HivekitConversation style dialog that will use the profile dialog as a child.
     */
    const onboarding = new HivekitConversation(ONBOARDING_DIALOG, controller);
