...
[Hivekit event types are controlled by the FacebookEventMiddleware](../reference/facebook.md#facebookeventtypemiddleware).
...
In Hivekit handlers, the `bot` worker for Facebook contains [all of the base methods](../reference/core.md#BotWorker) as well as the following platform-specific extensions:
