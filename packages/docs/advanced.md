...
Though many things have changed in the latest version of Hivekit, and it is not directly backwards compatible with previous versions,
...
Read [more about using hivekit-plugin-cms here](plugins/cms.html)
