# Hivekit for Hangouts Class Reference

[&larr; Hivekit Documentation](../core.md) [&larr; Class Index](index.md) 

This is a class reference for all the methods exposed by the [botbuilder-adapter-hangouts](https://github.com/texthive/hivekit/tree/master/packages/botbuilder-adapter-hangouts) package.
...
| resp| Partial&lt;HivekitMessage&gt; | A reply message containing text and/or cards<br/>
...
| Argument | Type | description
|--- |--- |---
| update| Partial&lt;HivekitMessage&gt; | An object in the form `{id: <id of message to update>, text: <new text>, card: <array of card objects>}`<br/>
