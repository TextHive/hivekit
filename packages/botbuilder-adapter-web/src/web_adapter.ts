...
export class WebAdapter extends BotAdapter {
    /**
     * Name used to register this adapter with Hivekit.
     * @ignore
     */
    ...
    public init(hivekit): void {
        ...
        hivekit.ready(() => {
            this.createSocketServer(hivekit.http, this.socketServerOptions, hivekit.handleTurn.bind(hivekit));
        });
    }
        ...
        this.wss.on('connection', (ws) => {
            ...
            ws.on('message', (payload) => {
                try {
                    ...
                    // this stuff normally lives inside Hivekit.congfigureWebhookEndpoint
                    const activity = {
                        timestamp: new Date(),
                        channelId: 'websocket',
                        conversation: {
                    ...
                    // set hivekit's event type
                    if (activity.type !== ActivityTypes.Message) {
                        activity.channelData.hivekitEventType = message.type;
                    }
